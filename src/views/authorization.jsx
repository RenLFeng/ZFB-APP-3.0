          ...
          <div className={css.textInfo}>
            ...
            <div className={css.txtInfo}>
              <p>
                ...
                符合我司《合伙人合作协议》准入要求并已通过我司统一培训考核，现授权为深圳前海智付宝科技有限公司认证合伙人，并授权其使用智付宝APP进行合规展业。
              </p>
              <span className={css.theAuto}>
                授权推荐码：<i className={css.phone}>{userPhone}</i>
              </span>
              <p>
                合伙人需遵守国家及人民银行相关法律法规及智付宝营销规范要求合规展业，本授权有效期与被授权人的智付宝APP账户试用期限相同，特此授权!
              </p>
              <p>特别声明：本授权书必须与被授权人账户绑定使用，转载无效，不得影印、涂改、转让。</p>
            </div>
            <div className={css.foot}>
              <p align="right">深圳前海智付宝科技有限公司</p>
              <p align="right">
